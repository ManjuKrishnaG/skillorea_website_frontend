...
import "../../assets/styles/WhyStudySmart.css";
...
import icon4 from "../../assets/images/whyi6.png";
...
const cardData = [
  {
    image: icon1,
    background: bg1,
    text: "Personalized Learning, AI Guidance",
  },
  {
    image: icon2,
    background: bg2,
    text: "Active Sports, Safe Transport ",
  },
  {
    image: icon3,
    background: bg3,
    text: "Expert Support, Academic Excellence ",
  },
  {
    image: icon4,
    background: bg4,
    text: "Wellness & Doctor Support ",
  },
  {
    image: icon5,
    background: bg5,
    text: "Real Projects, Career Building",
  },
];
